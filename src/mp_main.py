...
class NextMapException(Exception):
    pass
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                e += 1
            except NextMapException:
                print("Next map")
                if args.no_gui:
                    env = gym_super_mario_bros.make(
                        "SuperMarioBros-1-2-v0", apply_api_compatibility=True)
                else:
                    env = gym_super_mario_bros.make(
                        "SuperMarioBros-1-2-v0", render_mode='human', apply_api_compatibility=True)
                env = JoypadSpace(env, COMPLEX_MOVEMENT)
