...
{
    cout << "Loading genome test case!" << endl;
    // vars
    int numInputs = 3;
    int numHidden = 2;
    int numOutputs = 3;
    ...
    // Load config
    this->LoadConfig(numNodes, nodes, numInputs, inputs, numOutputs, outputs, numHidden, hidden);
...
extern "C"
{
    ...
    void GenomeLoadRunTestCase(Genome *genome)
    {
        genome->LoadTestCase();
